import { CountriesListItemType } from './types';

export const sortByName = (countries: CountriesListItemType[], sortWay: string) =>
  sortWay === 'des'
    ? [...countries].sort((a, b) => a.name.localeCompare(b.name))
    : [...countries].sort((a, b) => b.name.localeCompare(a.name));

export const sortByNumbers = (countries: CountriesListItemType[], sortName: string, sortWay: string) => {
